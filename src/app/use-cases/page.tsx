...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "コミュニティ運営において、運営判断が遅れる原因は「能力」ではなく「構造」の問題であることが多いです。NELVOは、この構造的な課題を解決し、データに基づいた迅速な意思決定を実現します。Creators • Memberships • Teams",
    url: "https://nelvo.co/use-cases",
    siteName: "NELVO",
    type: "website",
    images: [{ url: "https://nelvo.co/og/og-usecases-ja.png", width: 1200, height: 630, alt: "NELVO Use Cases" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "NELVO Use Cases | Built for community operators",
    description: "コミュニティ運営において、運営判断が遅れる原因は「能力」ではなく「構造」の問題であることが多いです。NELVOは、この構造的な課題を解決し、データに基づいた迅速な意思決定を実現します。Creators • Memberships • Teams",
    images: ["https://nelvo.co/og/og-usecases-ja.png"],
  },
  robots: {
    index: true,
    follow: true,
